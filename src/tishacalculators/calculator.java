...
public class calculator extends javax.swing.JFrame {
 private double total1 = 0.0;
    ...
    private void BcosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BcosActionPerformed
        String btn_Text = Bcos.getText();
        r(btn_Text);
        total2 = Math.toRadians(total1);
        if (total1 == 90 || total1 == 270 || total1 == 450 || total1 == 630 || total1 == 810) {
            T_display.setText(String.format("0.0"));
        } else {
            T_display.setText(Double.toString(Math.cos(total2)));
        }
        total1 = 0;
    ...
    private void BsqureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BsqureActionPerformed
            String btn_Text = Bsqure.getText();
        r(btn_Text);
    ...
    private void BsinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BsinActionPerformed
             String btn_Text = Bsin.getText();
        r(btn_Text);
        total2 = Math.toRadians(total1);
        if (total1 == 180 || total1 == 360 || total1 == 720 || total1 == 14400) {
           T_display.setText(String.format("0.0"));
        } else {
           T_display.setText(Double.toString(Math.sin(total2)));
        }
        total1 = 0;
    ...
    private void BtanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtanActionPerformed
        String btn_Text =Btan.getText();
        r(btn_Text);
        total2 = Math.toRadians(total1);
        if (total1 == 90 || total1 == 270 || total1 == 450 || total1 == 630 || total1 == 810) {
            T_display.setText(String.format("∞"));
        } else if (total1 == 0 || total1 == 180 || total1 == 360 || total1 == 720 || total1 == 1440) {
          T_display.setText(String.format("0.0"));
        } else {
            T_display.setText(Double.toString(Math.tan(total2)));
        }
        total1 = 0;
